            ...
            <div className=" mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                        <DialogTrigger asChild>
                            <Button onClick={resetForm} className="gap-2 bg-black hover:bg-gray-800 text-white shadow-lg hover:shadow-xl transition-all">
                ...
                <Card className="border pb-5 py-0 overflow-hidden shadow-lg bg-white hover:shadow-xl transition-all duration-300">
                    <CardHeader className="bg-gray-50 py-5 rounded-t-lg border-b">
                        <CardTitle className="text-xl font-bold">Daftar Produk</CardTitle>
                    </CardHeader>
                    ...
                    <CardContent className="pb-8">
                            ...
                            <div className="flex flex-col gap-2 md:flex-row md:items-center">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => {
                                        ...
                                        // Jika kamu ingin langsung fetch produk berdasarkan gender:
                                        // fetchProducts({ gender: value === "all" ? "" : value });
                                    }}
                                >
                        ...
                        <div className="hidden lg:block rounded-xl border border-gray-200 overflow-hidden bg-white ">
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-50 border-b-2 border-gray-200">
                                        <TableHead className="text-center w-[80px] font-bold text-gray-700">No</TableHead>
                                        <TableHead className="font-bold text-gray-700">Gambar</TableHead>
                                        <TableHead className="font-bold text-gray-700 min-w-[200px]">Nama Produk</TableHead>
                                        <TableHead className="font-bold text-gray-700 min-w-[150px]">Detail</TableHead>
                                        <TableHead className="font-bold text-gray-700 min-w-[120px]">Harga</TableHead>
                                        <TableHead className="font-bold text-gray-700 text-center min-w-[140px]">Marketplace</TableHead>
                                        <TableHead className="font-bold text-gray-700 text-center min-w-[120px]">Aksi</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {!loading && products.map((product, index) => (
                                        <TableRow key={product.id} className="hover:bg-blue-50/50 transition-all duration-200 group">
                                                ...
                                                {product.images.length > 0 ? (
                                                    <div className="relative">
                                                        <img
                                                            ...
                                                            alt={product.name}
                                                            className="w-20 h-20 object-cover rounded-xl border-2 border-gray-200 shadow-md group-hover:scale-105 group-hover:shadow-xl transition-all duration-300"
                                                        />
                                                    </div>
                                                ) : (
                                            ...
                                            <TableCell>
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex flex-wrap gap-1">
                                                        ...
                                                        <span className="text-xs px-2 py-0.5 bg-pink-50 text-pink-700 rounded-full border border-pink-200 font-medium">
                                            ...
                                            <TableCell>
                                                <div className="flex flex-col gap-2">
                                                    <a
                                                        ...
                                                        className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-green-50 text-green-700 hover:bg-green-100 rounded-lg font-semibold text-sm transition-all hover:shadow-md group/link"
                                                    >
                                                        <span>Tokopedia</span>
                                                    ...
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-orange-50 text-orange-700 hover:bg-orange-100 rounded-lg font-semibold text-sm transition-all hover:shadow-md group/link"
                                                    >
                                                        <span>Shopee</span>
                                                        <ExternalLink className="w-3.5 h-3.5 group-hover/link:translate-x-0.5 group-hover/link:-translate-y-0.5 transition-transform" />
                                                    </a>
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={7} className="text-center py-16">
                                                <div className="flex flex-col items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="text-xl font-bold text-gray-900 mb-2">Tidak ada data ditemukan</p>
                                ...
                                >
                                    <div className="p-4">
                                        ...
                                        <div className="flex flex-wrap gap-1.5 mb-3">
                                            ...
                                            <span className="px-2 py-1 rounded-md text-xs font-medium bg-amber-100 text-amber-700">
                                                {product.fragrance_notes_base}
                                            </span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-3 mb-3 pb-3 border-b border-gray-100">
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center gap-1.5 text-xs sm:text-sm text-green-600 hover:text-green-700 font-semibold"
                                            >
                                                Tokopedia
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center gap-1.5 text-xs sm:text-sm text-orange-600 hover:text-orange-700 font-semibold"
                                            >
                                                Shopee
                                                <ExternalLink className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                                            </a>
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                onClick={() => handleEditProduct(product)}
                                                className="flex-1 px-3 py-2 bg-blue-50 text-blue-700 rounded-lg font-medium text-sm hover:bg-blue-100 transition-colors flex items-center justify-center gap-1.5"
                                            >
                                                <Edit className="h-4 w-4" />
                                            ...
                                            <button
                                                onClick={() => handleDeleteClick(product)}
                                                className="flex-1 px-3 py-2 bg-red-50 text-red-700 rounded-lg font-medium text-sm hover:bg-red-100 transition-colors flex items-center justify-center gap-1.5"
                                            >
                                                <Trash2 className="h-4 w-4" />
                            ...
                            {loading && (
                                <div className="flex items-center justify-center py-12 sm:py-16">
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        <span className="text-gray-600 font-medium text-sm">Memuat data...</span>
                                    </div>
                                </div>
                            )}
                            ...
                            {!loading && products.length === 0 && (
                                <div className="text-center py-12 sm:py-16">
                                    <div className="bg-white rounded-xl shadow-md p-6 sm:p-8 border border-gray-200">
                                        ...
                                        <p className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Tidak ada data ditemukan</p>
